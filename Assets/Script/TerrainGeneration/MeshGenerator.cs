...
public class MeshGenerator: MonoBehaviour
{
    ...
    protected readonly Vector3[] DownFace = new Vector3[]
    {
        new Vector3(-0.5f, -0.5f, -0.5f),
        new Vector3(-0.5f, -0.5f, 0.5f),
        new Vector3(0.5f, -0.5f, 0.5f),
    ...
    protected readonly int[] DownTris = new int[] { 0, 2, 1, 0, 3, 2};
    ...
    private Vector3Int[] _allCheckDirections = new Vector3Int[6]
    {
        Vector3Int.right,
        Vector3Int.left,
        Vector3Int.up,
    ...
    public void SetupGenerator(BlockGrid blockGrid, TextureManager textureManager)
    {
        ...
        _cubeFaces.Add(Vector3Int.down, new FaceData(DownFace, DownTris, YUVOrder));
