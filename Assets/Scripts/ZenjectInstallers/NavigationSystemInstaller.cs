...
public sealed class NavigationSystemInstaller : MonoInstaller
{
    ...
    [SerializeField] private RoadWeightMapGenerator _roadWeightMapGenerator;
    ...
    public override void InstallBindings()
    {
        ...
        Container.Bind<RoadWeightMapGenerator>().FromInstance(_roadWeightMapGenerator).AsSingle().NonLazy();
        ...
        Container.Bind<RoadWeightMapHolder>().AsSingle().NonLazy();
    }
}